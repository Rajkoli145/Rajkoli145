...
# Raj Koli
### Full Stack Developer · Backend & APIs · AI Infrastructure

[![Typing SVG](https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=500&size=15&pause=1000&color=A89FD4&center=true&vCenter=true&width=650&lines=Building+complete+products+—+database+to+UI;React+%7C+Node.js+%7C+TypeScript+%7C+MongoDB;CLI+%26+systems+depth+most+devs+don't+have;Open+source+contributor+%7C+Navi+Mumbai+%F0%9F%87%AE%F0%9F%87%B3)](https://git.io/typing-svg)
...
```bash
$ whoami
> Raj Koli — Full Stack Developer, Navi Mumbai

$ cat stack.txt
> Frontend  → React, Next.js, Tailwind CSS
> Backend   → Node.js, Express, REST APIs, WebSockets
> Database  → MongoDB, Firebase
> Systems   → CLI tooling, Linux automation, shell scripting
> AI        → Prompt pipelines, model benchmarking, task design

$ cat currently.txt
> BTech CS @ ITM Skills University (2024–2028)
> Contributing to fintech SDK @ La Tanda (67+ API endpoints)
> Building in public — every repo is something shipped
```
...
<div align="center">
  <img src="https://streak-stats.demolab.com/?user=Rajkoli145&theme=tokyonight&hide_border=true&background=0d1117&ring=a89fd4&fire=a89fd4&currStreakLabel=a89fd4" height="165"/>
</div>
